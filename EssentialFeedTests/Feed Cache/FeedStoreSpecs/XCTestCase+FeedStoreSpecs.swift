    ...
    func expect(_ sut: FeedStore, toRetrieve expectedResult: FeedStore.RetrievalResult, file: StaticString = #file, line: UInt = #line) {
        ...
        sut.retrieve { retrivedResult in
            ...
            case let (.success(.some(expectedCache)), .success(.some(retrivedCache))):
                XCTAssertEqual(expectedCache.feed, retrivedCache.feed, file: file, line: line)
                XCTAssertEqual(expectedCache.timestamp, retrivedCache.timestamp, file: file, line: line)
